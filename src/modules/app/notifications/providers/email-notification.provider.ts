...
export class EmailNotificationProvider implements INotificationProvider {
  ...
  public async send(
    ...
    try {
      ...
      const sendWithRetry = async (): Promise<TEmailSendResult> => {
      ...
      this._logger.error('Failed to send email notification', {
        error,
        data: {
          notificationId,
        },
  ...
  private _initializeTransporter(): void {
    try {
      ...
      this._defaultFrom = this._moduleConfig.email.defaultFrom;
